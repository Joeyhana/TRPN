...
if __name__ == '__main__':
    ...
    tt.arg.test_model = './model_checkpoints/' if tt.arg.test_model is None else tt.arg.test_model
    ...
    gcn_module = TRPN(n_feat=tt.arg.emb_size, n_queries=tt.arg.num_ways_test * 1, hidden_layers = [640,320,320,160])
    ...
    checkpoint = torch.load(tt.arg.test_model + '/checkpoint.pth')
    # e()
